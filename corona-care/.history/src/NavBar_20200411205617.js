...
class NavBar extends Component {
  ...
  handleRedirectClick = name => {
    console.log("the 'name' being passed through ", name);
    // console.log("value for e.target.value in navbar", e.target.name);
    // this.props.handleMessageState(e.target.name);
      ...
      <React.Fragment>
        <div>
          <Link to="/">
            <Image
              name="home"
              onClick={this.handleRedirectClick("home")}
              size="small"
          ...
          <Menu.Item name="home" onClick={this.handleRedirectClick("home")}>
    ...
    return (
      <React.Fragment>
        <Menu.Item
          ...
          onClick={this.handleRedirectClick("myconvos")}
          as={Link}
          to="/myconvos"
        >
          Messages
