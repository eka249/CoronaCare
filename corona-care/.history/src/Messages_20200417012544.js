...
class Messages extends Component {
  ...
  messagesDisplay = () => {
    ...
    if (this.state.activeConversation) {
      console.log(
        "state of activeConversation beginning messagesDisplay function",
        this.state.activeConversation
      );
      var test = this.state.activeConversation;
      console.log(
        "var test (the state of activeConversation immediately after setting it as a variable)",
        test
      );
