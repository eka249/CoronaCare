...
class Messages extends Component {
  ...
  handleConvoClick = () => {
    ...
    this.convoDisplay(theConvos);
    console.log("theCovos coming from handleConvoClick", theConvos);
    // this.setMessagesState(theConvos);
    ...
    //   () =>
    //     console.log(
    //       "state of messages before exitiing setMessagesState",
    //       this.state.messages
    //     )
    // );
  };

  convoDisplay = theConvos => {
    var filteredConvo = theConvos;
    // var filteredConvo = theConvos[0].messages;
    console.log("before setting state", filteredConvo);
    // this.setState({
    //   filteredConvos: filteredConvo
    // });
    // console.log("after setting state", this.state.filteredConvos);
