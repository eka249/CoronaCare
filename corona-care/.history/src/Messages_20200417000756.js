...
class Messages extends Component {
  ...
  fetchConvos = () => {
    ...
    // .then(this.awaitConvoFetch);
  };

  awaitConvoFetch = () => {
    return Promise.all([this.handleRespond(), this.fetchConvos()]).then(
      this.handleConvoClick
    );
    //data erroring if separate function isn't created to wait on second convo fetch after responding
  };
  ...
  handleConvoClick = () => {
    console.log("convos when entering handleCovoClick", this.state.convos);
      ...
      return (
        <React.Fragment>
          ...
          <Form>
            ...
            <Button onClick={this.awaitConvoFetch}>Send</Button>
          </Form>
        </React.Fragment>
      );
    }
